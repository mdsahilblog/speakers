...
<header>
		<div class="top-bar_sub_w3layouts container-fluid">
			<div class="row">
				<div class="col-md-2 logo text-left">
					<a class="navbar-brand" href="index.php">
						<i class="fab fa-linode"></i> Akhtarspeaks</a>
				</div>
				...
				<nav class="navbar navbar-expand-md navbar-light ">
						...
						aria-expanded="false" aria-label="Toggle navigation">
                                        <span style="background-color: #01cd74;"class="navbar-toggler-icon"></span>
				   </button>
						...
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="contact.php">Contact</a>
                                                        ...
                                                        <li class="nav-item">
                                                                ...
                                                                <a class="nav-link" href="blogadmin/index.php">
                                                                       <i class="fas fa-lock"></i>Sign In</a>                                               
                                                        </li>
                                                        <!--<li class="nav-item">
                                                            <a class="nav-link" href="blogadmin/membership_signup.php">
							...
							<form action="search.php" method="post" class="form-inline my-2 my-lg-0 header-search" name="form">
								...
								<button class="btn btn1 my-2 my-sm-0" type="submit" name="submit"><i class="fas fa-search"></i></button>
                                    ...
                                    <div class="col-md-2 log-icons text-right">

					<ul class="social_list1 mt-1 ">
